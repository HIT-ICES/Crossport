...
#pragma warning restore 0067
        ...
        public virtual ReadOnlyArray<InputDevice> devices { get { return InputSystem.devices; } }

        public virtual IEnumerable<string> layouts { get { return InputSystem.ListLayouts(); } }

        public virtual InputDevice GetDeviceById(int deviceId) { return InputSystem.GetDeviceById(deviceId); }
        ...
        public virtual InputControlLayout LoadLayout(string name) { return InputSystem.LoadLayout(name); }
        ...
        public virtual void RemoveLayout(string name) { InputSystem.RemoveLayout(name); }

        public virtual void QueueEvent(InputEventPtr eventPtr) { InputSystem.QueueEvent(eventPtr); }
    }
}
// #endif