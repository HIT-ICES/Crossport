...
namespace Ices.Crossport.Core.DualHandling.InputSystem
{
    ...
    static class InputDeviceExtension
    {
        ...
        static InputDeviceExtension()
        {
            ...
            fieldInfoParticipantId = typeInputDevice.GetField
            (
                "m_ParticipantId",
                BindingFlags.NonPublic | BindingFlags.Instance
            );
            fieldInfoDescription = typeInputDevice.GetField
            (
                "m_Description",
                BindingFlags.NonPublic | BindingFlags.Instance
            );
            fieldInfoDeviceFlags = typeInputDevice.GetField
            (
                "m_DeviceFlags",
                BindingFlags.NonPublic | BindingFlags.Instance
            );
        ...
        public static int GetDeviceFlags(this InputDevice device) { return (int)fieldInfoDeviceFlags.GetValue(device); }
    }
}
// #endif