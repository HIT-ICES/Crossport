...
namespace Anonymous.Crossport.Core.DualHandling.InputSystem
{
    ...
    /// </summary>
    partial class DualHandlingReceiverCore
    {
        ...
        {
            InputField m_field;
            public UGUIInputField(InputField field) { m_field = field; }

            public void ProcessEvent(Event e) { m_field.ProcessEvent(e); }
            public void ForceLabelUpdate() { m_field.ForceLabelUpdate(); }
            public void AppendText(char character) { m_field.text += character; }
        }
