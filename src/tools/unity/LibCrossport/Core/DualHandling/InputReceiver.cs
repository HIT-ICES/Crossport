...
namespace Anonymous.Crossport.Core.DualHandling
{
    ...
    /// </summary>
    public class DualHandlingInputReceiver : InputChannelReceiverBase
    {
        ...
        ///
        /// </summary>
        public string defaultActionMap { get => m_DefaultActionMap; set => m_DefaultActionMap = value; }
        ...
        public void SwitchCurrentActionMap(string mapNameOrId)
        {
            ...
            if (!m_Enabled)
            {
                RenderStreaming.Logger.Log
                    (LogType.Error, (object)$"Cannot switch to actions '{mapNameOrId}'; input is not enabled", this);
                return;
            }
            ...
            if (m_Actions == null)
            {
                ...
                (
                    LogType.Error,
                    (object)$"Cannot switch to actions '{mapNameOrId}'; no actions set on PlayerInput",
                    this
                );
                return;
            }
            ...
            {
                RenderStreaming.Logger.Log
                    (LogType.Error, (object)$"Cannot find action map '{mapNameOrId}' in actions '{m_Actions}'", this);
                return;
            }
        ...
        public override void SetChannel(string connectionId, RTCDataChannel channel)
        {
            ...
            {
                receiver = new DualHandlingReceiverCore(channel);
        ...
        public void SetEnableInputPositionCorrection(bool enabled) { receiver.EnableInputPositionCorrection = enabled; }
        ...
        [Tooltip("Input actions associated with the player.")] [SerializeField] internal InputActionAsset m_Actions;
        ...
        [NonSerialized] private DualHandlingReceiverCore receiver;
        ...
        private void UnassignUserAndDevices() { m_InputUser.UnpairDevicesAndRemoveUser(); }

        /// <summary>
        /// FerS:: binding: inputAsset => actionEvent
        ///     ?? How RtcData => actionEvent
        /// </summary>
        private void InitializeActions()
        {
            ...
            for (var actionMap = 0; actionMap < oldActions.actionMaps.Count; actionMap++)
            {
                for (var binding = 0; binding < oldActions.actionMaps[actionMap].bindings.Count; binding++)
                    m_Actions.actionMaps[actionMap]
