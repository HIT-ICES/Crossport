...
public class DBSetup : MonoBehaviour
{
    ...
    public static void insertItems()
    {
        ...
        item.subType = ItemData.ItemSubType.Health;
        item.create();
        ...
        item.subType = ItemData.ItemSubType.Necklace;
        item.create();
        ...
        item.subType = ItemData.ItemSubType.Wand;
        item.create();

        item = new ItemData();
        item.id = id++;
        item.price = 40;
        item.type = ItemData.ItemType.Useless;
        item.subType = ItemData.ItemSubType.Scrap;
        item.create();
        ...
        item.price = 40;
        item.type = ItemData.ItemType.Armor;
        item.subType = ItemData.ItemSubType.Ring;
        item.create();
        ...
        item.price = 40;
        item.type = ItemData.ItemType.Armor;
        item.subType = ItemData.ItemSubType.Chest;
        item.create();
        ...
        item.price = 40;
        item.type = ItemData.ItemType.Armor;
        item.subType = ItemData.ItemSubType.Hands;
        item.create();
