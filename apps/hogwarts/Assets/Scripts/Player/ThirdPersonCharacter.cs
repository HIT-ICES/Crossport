...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        [SerializeField] private readonly float m_JumpPower = 12f;
        [SerializeField] private readonly float m_MoveSpeedMultiplier = 1f;
        [SerializeField] private readonly float m_MovingTurnSpeed = 280f;
        ...
        [SerializeField] private readonly float m_StationaryTurnSpeed = 90f;
